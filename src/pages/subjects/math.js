  ...
  useEffect(() => {
    ...
    async function fetchMathData() {
      try {
        ...
        // Получаем документ регламента для математики (doc6)
        const docData = await documentsService.getDocumentById('doc6');
        console.log('Math regulation document loaded from Firebase:', docData);
