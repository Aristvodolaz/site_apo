...
export default function BiologySubject() {
  // Get biology data from the subjectsData
  const biologyData = subjectsData.find(subject => subject.id === 'biology');
  ...
  return (
    <Layout title="Биология">
      <div className="subject-header" style={{ background: 'linear-gradient(135deg, #167a39 0%, #28a745 50%, #5fd855 100%)' }}>
        <div className="container py-5 position-relative z-index-1">
          <div className="row align-items-center">
            <div className="col-lg-8">
              <h1 className="text-white display-4 fw-bold mb-3">Биология</h1>
              <p className="text-white opacity-90 lead mb-4">Олимпиада по биологии для учащихся 5-11 классов</p>
            ...
            <div className="col-lg-4 d-none d-lg-block">
              <div className="subject-icon-wrapper">
                <div className="subject-icon-container">
                  <i className="bi bi-tree subject-icon-large"></i>
          ...
          <div className="snowflakes">
            {[...Array(8)].map((_, i) => (
              <div key={i} className="snowflake">
                <div className="inner"><i className="bi bi-tree"></i></div>
              </div>
            ))}
          </div>
        )}
        ...
        <div className="row g-4">
          <div className="col-lg-8">
            <section className="mb-5">
              <h2 className="section-title mb-4">О профиле «Биология»</h2>
              ...
              <div className="row mt-4 g-4">
                <div className="col-md-6">
                  <div className="subject-info-card h-100">
                    ...
                    <div className="subject-info-icon" style={{background: 'rgba(40, 167, 69, 0.1)', color: '#28a745'}}>
                ...
                <div className="col-md-6">
                  <div className="subject-info-card h-100">
                    ...
                    <p className="subject-info-text">
                      {biologyData.locations ? biologyData.locations.join(', ') : 'Информация будет доступна позже'}
                    </p>
                  </div>
                </div>
              </div>

              <div className="subject-info-box mt-4" style={{background: 'linear-gradient(135deg, rgba(40, 167, 69, 0.05), rgba(95, 216, 85, 0.05))'}}>
                <div className="d-flex">
                  <div className="subject-info-box-icon" style={{background: 'rgba(40, 167, 69, 0.1)', color: '#28a745'}}>
                    <i className="bi bi-info-circle"></i>
                  </div>
                  <div>
                    <h5 className="subject-info-box-title">Важный принцип олимпиады</h5>
                    <p className="subject-info-box-text">
                      Арктическая олимпиада уделяет особое внимание составлению заданий для учащихся младших классов (5-6), 
            ...
            <section className="mb-5">
              ...
              <div className="row g-4">
                <div className="col-md-6">
                  <div className="subject-phase-card qualification">
                    <div className="phase-decoration" style={{background: 'linear-gradient(to right, #28a745, #5fd855)'}}></div>
                    <h3 className="phase-title" style={{color: '#28a745'}}>
                      <i className="bi bi-1-circle me-2"></i>
                      Отборочный этап
                    </h3>
                    <div className="phase-info">
                      <div className="d-flex align-items-center mb-3">
                        <div className="phase-icon me-3" style={{background: 'rgba(40, 167, 69, 0.1)', color: '#28a745'}}>
                          <i className="bi bi-calendar-event"></i>
                        </div>
                        <div>
                          <div className="phase-label">Даты проведения</div>
                          <div className="phase-value">{biologyData.schedule.qualification.start} - {biologyData.schedule.qualification.end}</div>
                        </div>
                      </div>
                      <div className="d-flex align-items-center mb-3">
                        <div className="phase-icon me-3" style={{background: 'rgba(40, 167, 69, 0.1)', color: '#28a745'}}>
                      ...
                      <div className="d-flex align-items-center">
                        ...
                        <div>
                          ...
                          <div className="phase-value">Все зарегистрированные школьники {biologyData.grades.join(', ')} классов</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="subject-phase-card final">
                    ...
                    <div className="phase-info">
                      <div className="d-flex align-items-center mb-3">
                        ...
                        <div>
                          <div className="phase-label">Даты проведения</div>
                          <div className="phase-value">{biologyData.schedule.final.start} - {biologyData.schedule.final.end}</div>
                        </div>
                      </div>
                      <div className="d-flex align-items-center mb-3">
                        <div className="phase-icon me-3" style={{background: 'rgba(40, 167, 69, 0.1)', color: '#28a745'}}>
              ...
              <div className="text-center mt-4">
                <Link href="/register" legacyBehavior>
                  <a className="btn-register" style={{background: 'linear-gradient(135deg, #28a745, #5fd855)'}}>
            ...
            <section className="mb-5">
              ...
              {biologyData.pastProblems && biologyData.pastProblems.length > 0 ? (
                <div className="past-problems-table">
                  {biologyData.pastProblems.map((year, index) => (
                    <div key={index} className="past-problems-year-card">
                      <div className="year-badge" style={{background: '#28a745'}}>{year.year}</div>
          ...
          <div className="col-lg-4">
            <div className="subject-sidebar" style={{ top: '2rem' }}>
              <div className="subject-sidebar-card">
                ...
                <ul className="sidebar-timeline">
                  <li className="sidebar-timeline-item">
                    <div className="timeline-badge" style={{borderColor: '#28a745'}}></div>
                    <div className="timeline-content">
                      <div className="timeline-title">Регистрация открыта до</div>
                      <div className="timeline-date" style={{color: '#28a745'}}>31.10.2024</div>
                    </div>
                  </li>
                  <li className="sidebar-timeline-item">
                    <div className="timeline-badge" style={{borderColor: '#28a745'}}></div>
                    <div className="timeline-content">
                      ...
                      <div className="timeline-date" style={{color: '#28a745'}}>01.11 - 15.11.2024</div>
                    </div>
                  </li>
                  <li className="sidebar-timeline-item">
                    <div className="timeline-badge" style={{borderColor: '#28a745'}}></div>
                    <div className="timeline-content">
                      ...
                      <div className="timeline-date" style={{color: '#28a745'}}>17.02 - 27.02.2025</div>
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="subject-sidebar-card">
                <h3 className="sidebar-card-title">
                  <i className="bi bi-file-earmark-text me-2" style={{color: '#28a745'}}></i>
                  Документы
                </h3>
                <ul className="sidebar-links">
                  <li>
                    <a href="/documents/biology_reglament_2025.pdf" className="sidebar-link" target="_blank" rel="noopener noreferrer">
                      <i className="bi bi-file-earmark-pdf" style={{color: '#28a745'}}></i>
              ...
              <div className="subject-sidebar-card">
                ...
                <ul className="sidebar-contacts">
                  <li>
                    <a href="mailto:biology@arctic-olympiad.ru" className="sidebar-contact-link">
                      <i className="bi bi-envelope-fill" style={{color: '#28a745'}}></i>
                      <span>biology@arctic-olympiad.ru</span>
                    </a>
                  </li>
                  <li>
              ...
              <div className="d-grid gap-2 mt-4">
                <Link href="/register" legacyBehavior>
                  <a className="btn-register d-flex align-items-center justify-content-center" style={{background: 'linear-gradient(135deg, #28a745, #5fd855)'}}>
                    <i className="bi bi-pencil-square me-2"></i>
                    <span>Зарегистрироваться</span>
                  </a>
                </Link>
                <Link href="/about/archive" legacyBehavior>
                  <a className="btn btn-outline-success d-flex align-items-center justify-content-center">
